...
ActiveRecord::Schema.define(version: 20_170_304_152_553) do
  ...
  create_table 'developers', force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    ...
    t.index %w(uid provider), name: 'index_developers_on_uid_and_provider', unique: true, using: :btree
  end

  create_table 'gem_suggestions', force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    t.text     'sentence', limit: 65_535, null: false
    t.integer  'developer_id'
